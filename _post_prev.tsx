...
export default function PostPropertyScreen() {
  ...
  const flowLabel = useMemo(() => {
    ...
    if (propertyCategory === 'land_plot' && adType === 'resale') return 'Land/Plot Resale';
    return '';
  }, [adType, propertyCategory]);
  ...
  const next = () => {
    ...
    if (step === 'uploads') {
      setError(null);
      if (adType === 'resale' || isCommercialAny || isLandPlot) {
  ...
  const createPropertyIfNeeded = async () => {
    ...
    const { data, error: insertError } = await supabase
      ...
      .insert({
        ...
        facing_road_width_ft: facingRoadWidthFt.trim() ? Number(facingRoadWidthFt) : null,
  ...
  const selectedAmenityLabels = useMemo(() => {
    const items: Array<{ label: string; value: 0 | 1 | null }> = [
      ...
      { label: 'Internet Provider', value: amenityInternetServices },
    ];
  ...
  const secondaryCountryCodeOptions = useMemo(() => {
    return [
      { label: '≡ƒç«≡ƒç│ India (+91)', value: '+91' },
      { label: '≡ƒç╡≡ƒç░ Pakistan (+92)', value: '+92' },
      { label: '≡ƒçº≡ƒç⌐ Bangladesh (+880)', value: '+880' },
      { label: '≡ƒç│≡ƒç╡ Nepal (+977)', value: '+977' },
      { label: '≡ƒç▒≡ƒç░ Sri Lanka (+94)', value: '+94' },
      { label: '≡ƒçª≡ƒç¬ UAE (+971)', value: '+971' },
      { label: '≡ƒç╕≡ƒçª Saudi Arabia (+966)', value: '+966' },
      { label: '≡ƒç¼≡ƒçº UK (+44)', value: '+44' },
      { label: '≡ƒç║≡ƒç╕ USA (+1)', value: '+1' },
      { label: '≡ƒç¿≡ƒçª Canada (+1)', value: '+1' },
    ] as const;
  }, []);
    ...
    <View style={{ flex: 1, backgroundColor: pageBg }}>
        ...
        <XStack alignItems="center" justifyContent="center" position="relative">
          ...
          <YStack alignItems="center">
            <Text color={titleColor} fontSize={16} fontWeight="900">
              {flowLabel ? `Post Property - ${flowLabel}` : 'Post Property'}
            </Text>
            <Text color={muted} fontSize={12} fontWeight="700">
              {step === 'basic'
                ? `Step 1 of ${adType === 'resale' ? 9 : adType === 'pg_hostel' ? 7 : isCommercialAny ? 9 : 8}`
                : step === 'details'
                  ? `Step 2 of ${adType === 'resale' ? 9 : isCommercialAny ? 9 : 8}`
                  : step === 'pg_room_types'
                    ? `Step 2 of 7`
                    : step === 'pg_room_details'
                      ? `Step 3 of 7`
                      : step === 'location'
                        ? `Step ${adType === 'pg_hostel' ? 4 : 3} of ${adType === 'resale' ? 9 : adType === 'pg_hostel' ? 7 : isCommercialAny ? 9 : 8}`
                        : step === 'pricing'
                          ? `Step 4 of ${adType === 'resale' ? 9 : isCommercialAny ? 9 : 8}`
                          : step === 'amenities'
                            ? `Step ${adType === 'pg_hostel' ? 5 : 5} of ${adType === 'resale' ? 9 : adType === 'pg_hostel' ? 7 : isCommercialAny ? 9 : 8}`
                            : step === 'uploads'
                              ? `Step ${adType === 'pg_hostel' ? 6 : 6} of ${adType === 'resale' ? 9 : adType === 'pg_hostel' ? 7 : isCommercialAny ? 9 : 8}`
                              : step === 'additional_info'
                                ? `Step 7 of 9`
                                : step === 'schedule'
                                  ? `Step ${adType === 'pg_hostel' ? 7 : isCommercialAny ? 8 : 8} of ${adType === 'resale' || isCommercialAny ? 9 : adType === 'pg_hostel' ? 7 : 8}`
                                  : `Step ${adType === 'resale' ? 9 : adType === 'pg_hostel' ? 7 : isCommercialAny ? 9 : 8} of ${adType === 'resale' || isCommercialAny ? 9 : adType === 'pg_hostel' ? 7 : 8}`}
            </Text>
          </YStack>
        </XStack>
      </YStack>
                        ...
                        ? commercialBuildingTypeOptions
                            ...
                            <Pressable
                              ...
                              <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                ...
                                <Text color={muted} fontWeight="900">
                                  {commercialBuildingType === it.value ? 'Γ£ô' : ''}
                                </Text>
                              </XStack>
                            </Pressable>
                          ))
                    ...
                    : pickerOpen === 'floor' || pickerOpen === 'totalFloors'
                        ? (
                            (
                              pickerOpen === 'floor'
                                ? (isCommercialAny
                                    ? (['Lower Basement', 'Upper Basement', 'Ground', 'Full Building', ...Array.from({ length: 99 }, (_, i) => String(i + 1))] as const)
                            ...
                            <Pressable
                              ...
                              <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                ...
                                <Text color={muted} fontWeight="900">
                                  {(pickerOpen === 'floor' ? floor : totalFloors) === v ? 'Γ£ô' : ''}
                                </Text>
                              </XStack>
                            </Pressable>
                          ))
                        : pickerOpen === 'propertyAge'
                          ...
                          : pickerOpen === 'commercialLeaseDurationYears' || pickerOpen === 'commercialLockinPeriodYears'
                            ? (Array.from({ length: 99 }, (_, i) => String(i + 1)) as const).map((v) => (
                                <Pressable
                                  key={v}
                                  onPress={() => {
                                  ...
                                  <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                    ...
                                    <Text color={muted} fontWeight="900">
                                      {(pickerOpen === 'commercialLeaseDurationYears' ? commercialLeaseDurationYears : commercialLockinPeriodYears) === v ? 'Γ£ô' : ''}
                                    </Text>
                                  </XStack>
                                </Pressable>
                              ))
                                ...
                                ? ([
                                    ...
                                    <Pressable
                                      ...
                                      <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                        ...
                                        <Text color={muted} fontWeight="900">
                                          {monthlyMaintenanceType === it.value ? 'Γ£ô' : ''}
                                        </Text>
                                      </XStack>
                                    </Pressable>
                                  ))
                                      ...
                                      ? stateOptions.map((s) => (
                                          <Pressable
                                            ...
                                            <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                              ...
                                              <Text color={muted} fontWeight="900">
                                                {stateValue.trim().toLowerCase() === String(s).trim().toLowerCase() ? 'Γ£ô' : ''}
                                              </Text>
                                            </XStack>
                                          </Pressable>
                                        ))
                                        ...
                                        ? (cityOptions ?? []).map((c) => (
                                            <Pressable
                                              ...
                                              <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                                ...
                                                <Text color={muted} fontWeight="900">
                                                  {cityValue.trim().toLowerCase() === String(c).trim().toLowerCase() ? 'Γ£ô' : ''}
                                                </Text>
                                              </XStack>
                                            </Pressable>
                                          ))
                        ...
                        ? ([
                            ...
                            <Pressable key={it.value} onPress={() => {
                              ...
                              <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                ...
                                <Text color={muted} fontWeight="900">
                                  {landElectricityConnection === it.value ? 'Γ£ô' : ''}
                                </Text>
                              </XStack>
                            </Pressable>
                          ))
                          ...
                          ? ([
                              ...
                              <Pressable key={it.value} onPress={() => {
                                ...
                                <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                  ...
                                  <Text color={muted} fontWeight="900">
                                    {landSewageConnection === it.value ? 'Γ£ô' : ''}
                                  </Text>
                                </XStack>
                              </Pressable>
                            ))
                              ...
                              ? ([
                                  ...
                                  <Pressable key={it.value} onPress={() => {
                                    ...
                                    <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                      ...
                                      <Text color={muted} fontWeight="900">
                                        {landSaleDeedCertificate === it.value ? 'Γ£ô' : ''}
                                      </Text>
                                    </XStack>
                                  </Pressable>
                                ))
                                ...
                                ? ([
                                    ...
                                    <Pressable key={it.value} onPress={() => {
                                      ...
                                      <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                        ...
                                        <Text color={muted} fontWeight="900">
                                          {landEncumbranceCertificate === it.value ? 'Γ£ô' : ''}
                                        </Text>
                                      </XStack>
                                    </Pressable>
                                  ))
                                  ...
                                  ? ([
                                      ...
                                      <Pressable key={it.value} onPress={() => {
                                        ...
                                        <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                          ...
                                          <Text color={muted} fontWeight="900">
                                            {landConversionCertificate === it.value ? 'Γ£ô' : ''}
                                          </Text>
                                        </XStack>
                                      </Pressable>
                                    ))
                                      ...
                                      ? ([
                                          ...
                                          <Pressable key={it.value} onPress={() => {
                                            ...
                                            <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                              ...
                                              <Text color={muted} fontWeight="900">
                                                {landKhataCertificate === it.value ? 'Γ£ô' : ''}
                                              </Text>
                                            </XStack>
                                          </Pressable>
                                        ))
                      ...
                      ? whoWillShowOptions.map((v) => (
                          <Pressable key={v} onPress={() => {
                            ...
                            <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                              ...
                              <Text color={muted} fontWeight="900">
                                {whoWillShowProperty === v ? 'Γ£ô' : ''}
                              </Text>
                            </XStack>
                          </Pressable>
                        ))
                      : pickerOpen === 'propertyCondition'
                        ? (isCommercialRent ? commercialPropertyConditionOptions : propertyConditionOptions).map((v) => (
                            <Pressable
                              key={v}
                              onPress={() => {
                              ...
                              <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                ...
                                <Text color={muted} fontWeight="900">
                                  {currentPropertyCondition === v ? 'Γ£ô' : ''}
                                </Text>
                              </XStack>
                            </Pressable>
                          ))
                          ...
                          ? commercialPreviousOccupancyOptions.map((it) => (
                              <Pressable
                                ...
                                <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                  ...
                                  <Text color={muted} fontWeight="900">
                                    {commercialPreviousOccupancy === it.value ? 'Γ£ô' : ''}
                                  </Text>
                                </XStack>
                              </Pressable>
                            ))
                            ...
                            ? secondaryCountryCodeOptions.map((it) => (
                                <Pressable
                                  ...
                                  <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                    ...
                                    <Text color={muted} fontWeight="900">
                                      {secondaryCountryCode === it.value ? 'Γ£ô' : ''}
                                    </Text>
                                  </XStack>
                                </Pressable>
                              ))
                          ...
                          ? yesNoDontKnowOptions.map((it) => (
                              <Pressable
                                ...
                                <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                  ...
                                  <Text color={muted} fontWeight="900">
                                    {saleDeedCertificate === it.value ? 'Γ£ô' : ''}
                                  </Text>
                                </XStack>
                              </Pressable>
                            ))
                                ...
                                ? yesNoDontKnowOptions.map((it) => (
                                    <Pressable
                                      ...
                                      <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                        ...
                                        <Text color={muted} fontWeight="900">
                                          {occupancyCertificate === it.value ? 'Γ£ô' : ''}
                                        </Text>
                                      </XStack>
                                    </Pressable>
                                  ))
                          ...
                          ? ([
                                ...
                                <Pressable
                                  ...
                                  <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                    ...
                                    <Text color={muted} fontWeight="900">
                                      {pgPreferredGuests === it.value ? 'Γ£ô' : ''}
                                    </Text>
                                  </XStack>
                                </Pressable>
                              ))
                            ...
                            ? commercialPowerBackupOptions.map((it) => (
                                <Pressable
                                  ...
                                  <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                    ...
                                    <Text color={muted} fontWeight="900">
                                      {commercialPowerBackupType === it.value ? 'Γ£ô' : ''}
                                    </Text>
                                  </XStack>
                                </Pressable>
                              ))
                              ...
                              ? commercialLiftOptions.map((it) => (
                                  <Pressable
                                    ...
                                    <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                      ...
                                      <Text color={muted} fontWeight="900">
                                        {commercialLiftType === it.value ? 'Γ£ô' : ''}
                                      </Text>
                                    </XStack>
                                  </Pressable>
                                ))
                                ...
                                ? commercialParkingOptions.map((it) => (
                                    <Pressable
                                      ...
                                      <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                        ...
                                        <Text color={muted} fontWeight="900">
                                          {commercialParkingType === it.value ? 'Γ£ô' : ''}
                                        </Text>
                                      </XStack>
                                    </Pressable>
                                  ))
                                  ...
                                  ? commercialWashroomOptions.map((it) => (
                                      <Pressable
                                        ...
                                        <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                          ...
                                          <Text color={muted} fontWeight="900">
                                            {commercialWashroomType === it.value ? 'Γ£ô' : ''}
                                          </Text>
                                        </XStack>
                                      </Pressable>
                                    ))
                                    ...
                                    ? commercialBusinessOptions.map((v) => (
                                        <Pressable
                                          ...
                                          <XStack paddingVertical={12} paddingHorizontal={10} borderRadius={10} alignItems="center" justifyContent="space-between">
                                            ...
                                            <Text color={muted} fontWeight="900">
                                              {commercialBusinessRunning === v ? 'Γ£ô' : ''}
                                            </Text>
                                          </XStack>
                                        </Pressable>
                                      ))
                    ...
                    <YStack flexGrow={1} minWidth={240} gap="$2">
                      ...
                      <XStack gap="$2" flexWrap="wrap">
                        <Button
                          ...
                          Single Room {flatmatesRoomType === 'single_room' ? 'Γ£ô' : ''}
                        </Button>
                        <Button
                          size="$2"
                          borderWidth={1}
                          ...
                          Shared Room {flatmatesRoomType === 'shared_room' ? 'Γ£ô' : ''}
                        </Button>
                      </XStack>
                    </YStack>
                    ...
                    <YStack flexGrow={1} minWidth={240} gap="$2">
                      ...
                      <XStack gap="$2" flexWrap="wrap">
                        <Button
                          ...
                          Male {flatmatesTenantType === 'male' ? 'Γ£ô' : ''}
                        </Button>
                        <Button
                          size="$2"
                          borderWidth={1}
                          ...
                          Female {flatmatesTenantType === 'female' ? 'Γ£ô' : ''}
                        </Button>
                      </XStack>
                    </YStack>
                  </XStack>
                ...
                <YStack gap="$2">
                  ...
                  <XStack gap="$2" flexWrap="wrap">
                    ...
                    <Button
                      ...
                      Bachelor Female {preferredBachelorFemale ? 'Γ£ô' : ''}
                    </Button>
                    <Button
                      size="$2"
                      borderWidth={1}
                      ...
                      Bachelor Male {preferredBachelorMale ? 'Γ£ô' : ''}
                    </Button>
                    <Button
                      size="$2"
                      borderWidth={1}
                    ...
                    <Pressable
                      ...
                      <XStack alignItems="center" gap="$2" paddingVertical={8}>
                        <YStack
                          ...
                          justifyContent="center">
                          <Text color="#FFFFFF" fontWeight="900" fontSize={12}>
                            {monthlyMaintenanceType === 'extra' ? 'Γ£ô' : ''}
                          </Text>
                        </YStack>
                        <Text color={titleColor} fontWeight="800">
                          Maintenance Extra
          ...
          {step === 'review' ? (
            <YStack gap="$3">
              ...
              {adType === 'pg_hostel' ? (
                <YStack backgroundColor="#FFFFFF" borderRadius={16} padding={14} borderWidth={1} borderColor={border} gap="$2">
                  ...
                  {pgFoodIncluded === 'yes'
                    ? reviewRow(
                        'Meals',
                        [pgMealBreakfast ? 'Breakfast' : '', pgMealLunch ? 'Lunch' : '', pgMealDinner ? 'Dinner' : ''].filter(Boolean).join(', ') || 'ΓÇö'
                      )
                    : null}
                  {reviewRow('Gate Closing Time', pgGateClosingTime ? formatTimeHhMm(pgGateClosingTime) : 'ΓÇö')}
              ...
              <YStack backgroundColor="#FFFFFF" borderRadius={16} padding={14} borderWidth={1} borderColor={border} gap="$2">
                ...
                {propertyCategory === 'commercial' && (adType === 'rent' || adType === 'sale') ? (
                  ...
                  <>
                    ...
                    {adType === 'flatmates' ? reviewRow('Room Type', flatmatesRoomType === 'single_room' ? 'Single Room' : flatmatesRoomType === 'shared_room' ? 'Shared Room' : 'ΓÇö') : null}
                    {adType === 'flatmates' ? reviewRow('Tenant Type', flatmatesTenantType ? (flatmatesTenantType === 'male' ? 'Male' : 'Female') : 'ΓÇö') : null}
              ...
              <YStack backgroundColor="#FFFFFF" borderRadius={16} padding={14} borderWidth={1} borderColor={border} gap="$2">
                ...
                {reviewRow('Map', mapPickerCoord ? `Lat ${mapPickerCoord.lat.toFixed(6)}, Lng ${mapPickerCoord.lng.toFixed(6)}` : 'ΓÇö')}
              </YStack>
              ...
              {adType === 'resale' ? (
                <YStack backgroundColor="#FFFFFF" borderRadius={16} padding={14} borderWidth={1} borderColor={border} gap="$2">
                  ...
                  {isLandPlot
                    ...
                    : reviewRow(
                        'Kitchen Type',
                        kitchenType === 'modular' ? 'Modular' : kitchenType === 'cupboard_shelf' ? 'Cupboard Shelves' : kitchenType === 'open_shelf' ? 'Open Shelves' : 'ΓÇö'
                      )}
                ...
                <YStack backgroundColor="#FFFFFF" borderRadius={16} padding={14} borderWidth={1} borderColor={border} gap="$2">
                  ...
                  {reviewRow('Expected Price', reviewValue(price))}
                  {reviewRow('Ownership Type', ownershipType === 'self_owned' ? 'Self Owned' : ownershipType === 'on_lease' ? 'On Lease' : 'ΓÇö')}
                  {reviewRow('Price Negotiable', reviewValue(rentNegotiable ? 'Yes' : 'No'))}
                  {reviewRow('Available From', availableFromDate ? formatDateDdMmYyyy(availableFromDate) : reviewValue(availableFromText))}
                  {reviewRow('Ideal For', commercialIdealForTags.length ? commercialIdealForTags.join(', ') : 'ΓÇö')}
                </YStack>
              ) : isCommercialRent ? (
                <YStack backgroundColor="#FFFFFF" borderRadius={16} padding={14} borderWidth={1} borderColor={border} gap="$2">
                ...
                <YStack backgroundColor="#FFFFFF" borderRadius={16} padding={14} borderWidth={1} borderColor={border} gap="$2">
                  ...
                  {reviewRow('Available From', availableFromDate ? formatDateDdMmYyyy(availableFromDate) : reviewValue(availableFromText))}
                  {reviewRow('Preferred Tenants', preferredAnyone ? 'Anyone' : [preferredFamily ? 'Family' : '', preferredBachelorFemale ? 'Bachelor Female' : '', preferredBachelorMale ? 'Bachelor Male' : '', preferredCompany ? 'Company' : ''].filter(Boolean).join(', ') || 'ΓÇö')}
              ...
              <YStack backgroundColor="#FFFFFF" borderRadius={16} padding={14} borderWidth={1} borderColor={border} gap="$2">
                ...
                {!scheduleAllDay ? reviewRow('Start time', scheduleStart ? formatTimeHhMm(scheduleStart) : 'ΓÇö') : null}
                {!scheduleAllDay ? reviewRow('End time', scheduleEnd ? formatTimeHhMm(scheduleEnd) : 'ΓÇö') : null}
              </YStack>
              ...
              <YStack backgroundColor="#FFFFFF" borderRadius={16} padding={14} borderWidth={1} borderColor={border} gap="$2">
                ...
                {adType === 'pg_hostel' ? (
                  ...
                  <>
                    ...
                    {flatmatesAttachedBathroom === 0 ? reviewRow('Bathroom Type', flatmatesBathroomType ? (flatmatesBathroomType === 'private' ? 'Private Bathroom' : 'Shared Bathroom') : 'ΓÇö') : null}
                    ...
                    {reviewRow('Secondary Phone', secondaryPhoneToSave ? reviewValue(secondaryPhoneToSave) : 'ΓÇö')}
                    {reviewRow('Water Supply', reviewValue(waterSupply))}
                    {reviewRow('Direction tip', reviewValue(directionTip))}
                    {reviewRow('Selected Amenities', selectedAmenityLabels.length ? selectedAmenityLabels.join(', ') : 'ΓÇö')}
                  </>
                ) : (
                  <>
                    {isCommercialAny ? (
                      ...
                      <>
                        {isLandPlot ? (
                          ...
                          <>
                            ...
                            {reviewRow('Gym', reviewYesNo(gym))}
                            {reviewRow('Power Backup', powerBackupType ? (powerBackupType === 'full' ? 'Full' : powerBackupType === 'partial' ? 'Partial' : 'None') : 'ΓÇö')}
                            {reviewRow('Direction tip', reviewValue(directionTip))}
                            {reviewRow('Selected Amenities', selectedAmenityLabels.length ? selectedAmenityLabels.join(', ') : 'ΓÇö')}
                          </>
                        )}
                ...
                <YStack backgroundColor="#FFFFFF" borderRadius={16} padding={14} borderWidth={1} borderColor={border} gap="$2">
                  ...
                  {isLandPlot ? (
                    <>
                      ...
                      {reviewRow('Sale Deed Certificate', landSaleDeedCertificate ? yesNoDontKnowText(landSaleDeedCertificate as any) : 'ΓÇö')}
                      {reviewRow('Encumbrance certificate', landEncumbranceCertificate ? yesNoDontKnowText(landEncumbranceCertificate as any) : 'ΓÇö')}
                      {reviewRow('Conversion certificate', landConversionCertificate ? (landConversionCertificate === 'not_needed' ? 'Not needed' : yesNoDontKnowText(landConversionCertificate as any)) : 'ΓÇö')}
                      {reviewRow('RERA Approved', landReraApproved ? (landReraApproved === 'yes' ? 'Yes' : 'No') : 'ΓÇö')}
                    </>
                  ) : (
                    <>
      ...
      <YStack position="absolute" bottom={0} left={0} right={0} backgroundColor="#FFFFFF" padding={14} borderTopWidth={1} borderTopColor="#E5E7EB">
        <XStack gap="$2" justifyContent="space-between" alignItems="center" flexWrap="wrap">
          ...
          {step !== 'review' ? (
            <Button disabled={saving} backgroundColor="#10B981" color="#FFFFFF" onPress={next}>
              <Text color="#FFFFFF" fontWeight="900" fontFamily="Times New Roman">
                Next
              </Text>
            </Button>
          ) : (
            <Button disabled={saving} backgroundColor="#10B981" color="#FFFFFF" onPress={() => void submit()}>
              <Text color="#FFFFFF" fontWeight="900" fontFamily="Times New Roman">
                {saving ? 'PostingΓÇª' : 'Post Property'}
              </Text>
            </Button>
          )}
        </XStack>
