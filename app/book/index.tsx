    ...
    <YStack flex={1} backgroundColor={theme.bg}>
      <YStack backgroundColor="#1F4E79" padding={16} paddingTop={18}>
        <XStack alignItems="center" justifyContent="center" position="relative">
          ...
          <YStack alignItems="center">
            ...
            <Text color="#CFE3F4" fontSize={13} fontWeight="600">
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 120, alignItems: 'center' }}>
        <YStack width={containerWidth} gap="$4">
            ...
            <>
              <YStack backgroundColor={theme.bgCard} borderRadius={14} padding={16} borderWidth={1} borderColor={theme.border} gap="$3">
                <XStack alignItems="center" gap="$2">
                  <Text fontSize={17} fontWeight="800" color="#2d56afff">
                    Customer Information
                  </Text>
                </XStack>
                <YStack gap="$2">
                  <Text fontSize={13} fontWeight="700" color="#456bbeff">
                    Full Name *
                  </Text>
                  <Input
                    {...inputUi}
                ...
                <YStack gap="$2">
                  <Text fontSize={13} fontWeight="700" color="#3d5faaff">
                    Mobile Number *
                  </Text>
                  <Input
                    {...inputUi}
                ...
                <YStack gap="$2">
                  <Text fontSize={13} fontWeight="700" color="#3d60acff">
                    Email (Optional)
                  </Text>
                  <Input
                    {...inputUi}
              ...
              <YStack backgroundColor={theme.bgCard} borderRadius={14} padding={16} borderWidth={1} borderColor={theme.border} gap="$3">
                <Text fontSize={17} fontWeight="800" color="#3c5ea8ff">
                  Type of Shifting
                </Text>
          ...
          {step === 'location' ? (
            <YStack backgroundColor={theme.bgCard} borderRadius={14} padding={16} borderWidth={1} borderColor={theme.border} gap="$3">
              <Text fontSize={17} fontWeight="800" color="#355cafff">
                Location
              </Text>

              <YStack gap="$3">
                <Text fontSize={14} fontWeight="800" color="#335aadff">
                  Pickup Address
                </Text>
                ...
                <XStack gap="$3" flexWrap="wrap">
                  <YStack flex={1} minWidth={220} gap="$2">
                    <Text fontSize={13} fontWeight="700" color="#3c5facff">
                      Floor
                    </Text>
                    <Pressable
                      onPress={() => {
                  ...
                  <YStack flex={1} minWidth={220} gap="$2">
                    <Text fontSize={13} fontWeight="700" color="#4062acff">
                      Lift
                    </Text>
                ...
                <Text fontSize={14} fontWeight="800" color="#4163adff">
                  Drop Address
                </Text>
                <XStack gap="$2" alignItems="center">
                  <YStack flex={1}>
                ...
                <XStack gap="$3" flexWrap="wrap">
                  <YStack flex={1} minWidth={220} gap="$2">
                    <Text fontSize={13} fontWeight="700" color="#4163adff">
                      Floor
                    </Text>
                    <Pressable
                      onPress={() => {
          ...
          <Dialog open={floorPickerOpen} onOpenChange={setFloorPickerOpen}>
            <Dialog.Portal>
              ...
              <Dialog.Content
                ...
                width={isWide ? 520 : '92%'}>
                <YStack gap="$3">
                  <Text fontSize={17} fontWeight="900" color="#3a5fafff">
          ...
          {step === 'vehicle' ? (
            <>
              <YStack backgroundColor={theme.bgCard} borderRadius={14} padding={16} borderWidth={1} borderColor={theme.border} gap="$3">
                <Text fontSize={17} fontWeight="800" color="#4163adff">
                  Select Vehicle
                </Text>
              ...
              <Dialog open={vehiclePickerOpen} onOpenChange={setVehiclePickerOpen}>
                <Dialog.Portal>
                  ...
                  <Dialog.Content backgroundColor={theme.bgCard} borderRadius={16} padding={16} width={isWide ? 620 : '92%'}>
                    <YStack gap="$3">
                      <Text fontSize={17} fontWeight="900" color="#4163adff">
                        Select Vehicle
                      </Text>
                      <YStack gap="$2">
                        {vehicleTypes.map((v) => {
                              ...
                              <YStack
                                ...
                                <XStack gap="$3" alignItems="center">
                                  ...
                                  <YStack flex={1} gap="$1" justifyContent="center">
                                    ...
                                    <Text fontSize={12} color="#64748B" numberOfLines={2}>
              ...
              <YStack backgroundColor={theme.bgCard} borderRadius={14} padding={16} borderWidth={1} borderColor={theme.border} gap="$3">
                <Text fontSize={17} fontWeight="800" color={theme.text}>
                  Schedule & Labor
                </Text>

                <YStack gap="$3">
                  <YStack gap="$2">
                    <Text fontSize={13} fontWeight="700" color={theme.text}>
                      Number of Laborers
                    </Text>
                  ...
                  <YStack
                    ...
                    alignItems="center">
                    <YStack>
                      <Text color="#CFE3F4" fontSize={13} fontWeight="700">
                        Estimated Price
                      </Text>
                      <Text color="#FFFFFF" fontSize={27} fontWeight="900">
                        {currency(total)}
                      </Text>
                    </YStack>
                    <YStack alignItems="flex-end">
                      ...
                      <Text color="#FFFFFF" fontSize={19} fontWeight="900">
          ...
          <Dialog open={laborPickerOpen} onOpenChange={setLaborPickerOpen}>
            <Dialog.Portal>
              ...
              <Dialog.Content backgroundColor={theme.bgCard} borderRadius={16} padding={16} width={isWide ? 520 : '92%'}>
                <YStack gap="$3">
                  <Text fontSize={17} fontWeight="900" color={theme.text}>
                    Select Laborers
                  </Text>
                  <YStack gap="$2">
            ...
            <YStack gap="$4">
              ...
              <YStack backgroundColor={theme.bgCard} borderRadius={14} padding={16} borderWidth={1} borderColor={theme.border} gap="$3">
                ...
                <YStack gap="$2">
                  ...
                  <YStack height={1} backgroundColor={theme.bgSecondary} marginVertical={8} />
                  <XStack justifyContent="space-between">
                    <Text fontSize={17} fontWeight="900">Total</Text>
                    <Text fontSize={17} fontWeight="900">{currency(total)}</Text>
                  </XStack>
                  ...
                  <XStack justifyContent="space-between">
                    <Text fontSize={17} fontWeight="900">Remaining</Text>
                    <Text fontSize={17} fontWeight="900">{currency(Math.max(total - form.advanceAmount, 0))}</Text>
                  </XStack>
                </YStack>
              </YStack>
          ...
          <Dialog.Content width={isWide ? 520 : '92%'} borderRadius={18} backgroundColor={theme.bgCard} padding={18}>
            <YStack gap="$3" alignItems="center">
              <YStack width={72} height={72} borderRadius={999} backgroundColor="#1F4E79" alignItems="center" justifyContent="center">
                <Text color="#FFFFFF" fontSize={29} fontWeight="900">
                  🔒
                </Text>
              </YStack>
              ...
              <YStack backgroundColor="#FEF3C7" borderRadius={14} padding={14} borderWidth={1} borderColor="#F59E0B" width="100%" gap="$3" flexDirection="row" alignItems="center">
                <YStack flex={1} minWidth={0}>
                  ...
                  <Text color="#B45309" fontSize={13} flexShrink={1}>Pay now to confirm booking</Text>
                </YStack>
                <Text
                  color="#92400E"
                  fontSize={19}
      ...
      <Modal visible={mediaViewerOpen} transparent animationType="fade" onRequestClose={() => setMediaViewerOpen(false)}>
        <Pressable
          ...
          <Pressable onPress={() => {}} style={{ width: '100%', maxWidth: 760, alignItems: 'center' }}>
            ...
            <Text color="#CBD5E1" fontSize={14} fontWeight="700" marginTop={14}>
