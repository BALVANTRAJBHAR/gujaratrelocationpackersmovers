      ...
      <Animated.View
        ...
        <YStack
          ...
          <XStack
            ...
            <Text color="#0B6B8F" fontSize={12} fontWeight="900" style={{ fontFamily: APP_FONT }}>
          ...
          <YStack width="100%" gap="$2" marginTop={6}>
            ...
            <Text color="#64748B" fontSize={11} fontWeight="700" textAlign="center" style={{ fontFamily: APP_FONT }}>
              Preparing your moving experience
            </Text>
          </YStack>
        </YStack>

        <Text color="#64748B" fontSize={11} fontWeight="700" marginTop={18} style={{ fontFamily: APP_FONT }}>
