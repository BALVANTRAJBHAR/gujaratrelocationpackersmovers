...
export default function PostPropertyScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: pageBg }}>
      <YStack backgroundColor={theme.couponBg} padding={16} paddingTop={16 + insets.top} borderBottomWidth={1} borderBottomColor={border}>
                      ...
                      <Pressable key={it.label} onPress={() => it.setV(!it.v)}>
                        <XStack alignItems="center" gap="$2" paddingVertical={6}>
                          <YStack
                            ...
                            alignItems="center"
                            justifyContent="center">
                            <Text color="#FFFFFF" fontWeight="900" fontSize={t(14)}>
                              {it.v ? '✓' : ''}
                            </Text>
                          </YStack>
                          <Text color={titleColor} fontWeight="800">
                ...
                <XStack gap="$2" flexWrap="wrap">
                  <Button
                    ...
                    <YStack alignItems="center" gap={2}>
                      ...
                      <Text color={scheduleAvailability === 'everyday' ? theme.couponText : muted} fontSize={t(13)} fontWeight="700">
                        Mon-Sun
                      </Text>
                    </YStack>
                  </Button>
                  <Button
                    ...
                    <YStack alignItems="center" gap={2}>
                      ...
                      <Text color={scheduleAvailability === 'weekday' ? theme.couponText : muted} fontSize={t(13)} fontWeight="700">
                        Mon-Fri
                      </Text>
                    </YStack>
                  </Button>
                  <Button
                    ...
                    <YStack alignItems="center" gap={2}>
                      ...
                      <Text color={scheduleAvailability === 'weekend' ? theme.couponText : muted} fontSize={t(13)} fontWeight="700">
                        Sat-Sun
                      </Text>
                    </YStack>
                  </Button>
                ...
                <>
                  <XStack gap="$2" flexWrap="wrap">
                    <Input
                      ...
                      minWidth={220}
                    />
                    <Text color={muted} fontSize={t(14)} fontWeight="800" alignSelf="center">
                      / Month
                    </Text>
                  </XStack>
                  ...
                  <YStack gap="$2">
                    <XStack alignItems="center" gap="$2">
                      ...
                      <Pressable
                        ...
                        <Text color={muted} fontSize={t(14)} fontWeight="900">
                          i
                        </Text>
                      </Pressable>
                    </XStack>
