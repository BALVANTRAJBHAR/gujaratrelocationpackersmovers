      ...
      <YStack backgroundColor={theme.couponBg} padding={16} paddingTop={18} borderBottomWidth={1} borderBottomColor={border}>
        <XStack alignItems="center" justifyContent="center" position="relative">
          ...
          <YStack alignItems="center">
            ...
            <Text color={muted} fontSize={14} fontWeight="700">
                ...
                <XStack gap="$2" flexWrap="wrap">
                  <Button
                    ...
                    <YStack alignItems="center" gap={2}>
                      ...
                      <Text color={scheduleAvailability === 'everyday' ? theme.couponText : muted} fontSize={13} fontWeight="700">
                        Mon-Sun
                      </Text>
                    </YStack>
                  </Button>
                  <Button
                    ...
                    <YStack alignItems="center" gap={2}>
                      ...
                      <Text color={scheduleAvailability === 'weekday' ? theme.couponText : muted} fontSize={13} fontWeight="700">
                        Mon-Fri
                      </Text>
                    </YStack>
                  </Button>
                  <Button
                    ...
                    <YStack alignItems="center" gap={2}>
                      ...
                      <Text color={scheduleAvailability === 'weekend' ? theme.couponText : muted} fontSize={13} fontWeight="700">
                        Sat-Sun
                      </Text>
                    </YStack>
                  </Button>
                ...
                <>
                  <XStack gap="$2" flexWrap="wrap">
                    <Input
                      ...
                      minWidth={220}
                    />
                    <Text color={muted} fontSize={14} fontWeight="800" alignSelf="center">
                      / Month
                    </Text>
                  </XStack>
                  ...
                  <YStack gap="$2">
                    <XStack alignItems="center" gap="$2">
                      ...
                      <Pressable
                        ...
                        <Text color={muted} fontSize={14} fontWeight="900">
                          i
                        </Text>
                      </Pressable>
                    </XStack>
